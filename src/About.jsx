  ...
  return (
    <>
      <div class="navbar" id="About">
            ...
            <h3>Developing in Minneapolis, MN</h3>
            <p>/* This website and other projects listed below showcase just a few of my interests and skills. 
                  ...
                  of computer science in order to bring new tools, applications, and opportunities to others. <span class="blink_me_about">_</span> */</p>
      </div>
